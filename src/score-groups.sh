...
npm run eval https://douglas.firebaseio.com >>scores.log 2>/dev/null

echo Evaluating students\' answers from https://linus.firebaseio.com ...
npm run eval https://linus.firebaseio.com >>scores.log 2>/dev/null

echo Evaluating students\' answers from https://eich.firebaseio.com ...
npm run eval https://eich.firebaseio.com >>scores.log 2>/dev/null
