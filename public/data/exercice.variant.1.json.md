...
3. Selon le même modèle, afficher ensuite la multiplication de ce nombre par chaque nombre de `4` à `6` (compris) dans la console; (faire un appel à `console.log()` pour chaque multiplication à afficher);
